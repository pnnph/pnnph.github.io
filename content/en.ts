...
export const en = {
  ...
  maqzinoPage: {
    ...
    galleryNote: "English interface, dark theme. Tap any screen to see it larger.",
    shots: [
      ...
      "Right lateral ventricle, pulled out of the brain with 'fade others'",
      "Explode mode at 86 per cent — every piece pulled apart",
